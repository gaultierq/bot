...
export type GetConversationQuery = { __typename?: 'Query' } & {
  getConversation: { __typename?: 'GetConversationResult' } & {
    ...
    { __typename?: 'Conversation' } & Pick<Conversation, 'id' | 'botId'> & {
      answers?: Maybe<
      Array<
      { __typename?: 'Answer' } & Pick<Answer, 'id' | 'createdAt' | 'content'> & {
        interaction?: Maybe<{ __typename?: 'Interaction' } & Pick<Interaction, 'id' | 'content'>>;
      }
      >
      >;
 ...
 *
 * To run a query within a React component, call `useNextInteractionQuery` and pass it any options that fit your needs.
 * When your component renders, `useNextInteractionQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
